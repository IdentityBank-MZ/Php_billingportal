...
$this->title = Translate::_('billing', 'Login Page');
...
<div class="container">
    ...
    <p><?= Translate::_('billing', 'Please fill out the following fields to login to the Identity Bank') ?></p>
