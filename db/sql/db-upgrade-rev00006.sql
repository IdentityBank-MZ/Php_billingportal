...
-- # ---------------------------------------------------------------------- # --
-- # Table: p57b_log.billing_authlog
-- # ---------------------------------------------------------------------- # --

DROP TABLE IF EXISTS "p57b_log"."billing_authlog";

CREATE TABLE "p57b_log"."billing_authlog"
(
...
CREATE INDEX billing_authlog_idx_uid ON "p57b_log"."billing_authlog" ("uid");

ALTER TABLE "p57b_log"."billing_authlog" OWNER TO p57b_log;
